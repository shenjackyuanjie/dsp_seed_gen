...
{
	// Token: 0x06003A91 RID: 14993 RVA: 0x0030E308 File Offset: 0x0030C508
	...
	// Token: 0x06003A92 RID: 14994 RVA: 0x0030E63C File Offset: 0x0030C83C
	public override void GenerateVegetables()
	{
		...
		for (int i = 0; i < data.dataLength; i++)
		{
			...
			if (num12 % 2 == 1 && num13 % 2 == 1)
			{
				...
				{
					bool flag2 = true;
					if (PlanetAlgorithm1.diff(num17, num18) > 0.2f)
					{
						flag2 = false;
					}
					if (PlanetAlgorithm1.diff(num17, num19) > 0.2f)
					{
						flag2 = false;
					}
					if (PlanetAlgorithm1.diff(num17, num20) > 0.2f)
					{
						flag2 = false;
					}
					if (PlanetAlgorithm1.diff(num17, num21) > 0.2f)
					{
						flag2 = false;
					}
	...
	// Token: 0x06003A93 RID: 14995 RVA: 0x0030EFCF File Offset: 0x0030D1CF
