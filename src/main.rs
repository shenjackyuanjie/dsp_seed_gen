...
fn rand_name() {
    ...
    println!(
        "and a star: {}! ",
        name_gen::random_star_name_from_raw_names(now_time)
    );
    println!(
        "and a netron star: {}! ",
    ...
    println!(
        "and a black hole: {}! ",
        name_gen::random_black_hole_name_with_format(now_time)
    );
    println!(
        "and a giant: {}! ",
        name_gen::random_giant_star_name_from_raw_names(now_time)
    );
    println!(
        "and a giant: {}! ",
    ...
    println!(
        "and a giant: {}! ",
        name_gen::random_giant_star_name_with_format(now_time)
    );
}
